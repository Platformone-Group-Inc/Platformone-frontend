    ...
    <div>
      <div className="mx-auto max-w-xl space-y-8 text-center">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="text-left space-y-2">
                ...
                <Textarea cols={10}>
                  ...
                  Soluta non nobis iste molestias impedit. Ipsum ratione
                  excepturi quos unde nisi? Alias, quisquam cumque aliquid vitae
                  cupiditate repellendus fuga ipsam perspiciatis?
                </Textarea>
        ...
        <div className="flex items-center justify-end w-full">
          {formStep > 1 && (
            <Button type="button" onClick={() => setFormStep((p) => p--)}>
              Previous
            </Button>
          )}
          <Button type="button" onClick={() => setFormStep((p) => p++)}>
