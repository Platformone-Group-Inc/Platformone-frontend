    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-auto p-2">
        <div className="flex items-center justify-between">
          ...
          >
            <Button variant="transparent" size="icon" onClick={onPrevMonth}>
              <ChevronLeftIcon />
            </Button>
            <Button variant="transparent" size="icon" onClick={onNextMonth}>
              <ChevronRightIcon />
            </Button>
          </div>
        </div>
            ...
            {years.map((year) => (
              ...
              >
                <Button
                  ...
                  variant={
                    getYear(value) === year.value ? "default" : "transparent"
                  }
          ...
          <div className="grid grid-cols-3 gap-4">
            {months.map((month) => (
              <Button
                ...
                variant={
                  getMonth(value) === month.value ? "default" : "transparent"
                }
                className="rounded-full"
                onClick={() =>
